    ...
    <footer className="bg-gray-900 text-gray-300 pt-13 pb-6">
      <div className="container mx-auto px-2">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-0">
          ...
          <div className="space-y-4">
            <div className="flex items-center">
              ...
              <span className="text-2xl font-bold text-white">PR Varthagam</span>
            </div>
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li>
                <Link  className="text-gray-400 hover:text-amber-500 transition-colors">
                  Black Pepper
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-5">
              ...
              <li className="flex items-center">
                ...
                <span className="text-gray-400">+44-7769027118</span>
              </li>
              <li className="flex items-center">
                <EnvelopeIcon className="h-5 w-5 text-amber-500 mr-3" />
                <span className="text-gray-400">prabhudassuk@gmail.com</span>
              </li>
              <li className="flex items-center">
        ...
        <div className="border-t border-gray-800 mt-12 pt-8 text-center text-gray-500">
          <p>
            &copy; {new Date().getFullYear()} PR Varthagam Spices. All rights reserved. | 
